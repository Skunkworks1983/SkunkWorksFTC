...
public class Gyro extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        gyroDrive(DRIVE_SPEED, 7, 0.0);    // Drive FWD 48 inches
    ...
    public void gyroDrive (double speed,
        ...
        if (opModeIsActive()) {
            ...
            newLeftTarget = robot.leftMotor1.getCurrentPosition() + moveCounts;
            newRightTarget = robot.rightMotor1.getCurrentPosition() + moveCounts;
                            ...
                            robot.rightMotor1.isBusy() && robot.rightMotor2.isBusy()))
            {
                ...
                robot.setLeftPower(leftSpeed);
                robot.setRightPower(rightSpeed);

                // Display drive status for the driver.
                telemetry.addData("Err/St",  "%5.1f/%5.1f",  error, steer);
                telemetry.addData("Target",  "%7d:%7d",      newLeftTarget,  newRightTarget);
                telemetry.addData("Actual",  "%7d:%7d",      robot.leftMotor1.getCurrentPosition(),
